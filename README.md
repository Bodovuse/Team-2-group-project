...
\ ollamaMain is called and the csv file is then passed to Ollama which corrects the grammar and saves to corrected_sentence column in transcript.csv\
...
All function library code must be modular and changes to one lib file do not affect another lib
